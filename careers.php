...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Grocery Store| online Dairy products available Here</title>
                ...
                <div class="col-md-6 m-auto">
                    ...
                    <a href="" class="btn btn-primary text-light px-1 py-0"> <i class="fa fa-instagram"></i> </a>
                        ...
                        <div class="col-md-6 p-2 text-right">
                             <a href="" class=" text-light mr-3"> <i class="fa fa-phone"></i>+91 6390663163</a>
                             <a href="" class="text-light "> <i class="fa fa-envelope"></i>grocerystore@gmail.com</a>
                    </div>
             </div>
    </div>
