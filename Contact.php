...
<head>
	<meta charset="utf-8">
  <title>Gorcery Store| online Dairy products available Here</title>
    ...
    <div class="card shadow m-4" style="background:linear-gradient(#f2ffff,#d6fffe,#b3fffd)">
      <div class="container align-items-center">
        ...
        <h3 >customer support</h3>
            <span>call us: <a href="#">+91 6390663163</a></span><br>
            <span>Email: <a href="#">grocerystore@gmail.com</a> </span><br>
            follow us on: <br>

								<a href="https://www.instagram.com/ideasdo/" class="btn btn-info text-light px-1 py-0"> <i class="fa fa-instagram"></i> </a>
								<a href="https://www.youtube.com/channel/UCk8bnLG1sxzc3KamQF9xk5g?view_as=subscriber" class="btn btn-danger text-light px-1 py-0"> <i class="fa fa-youtube"></i> </a>
								<a href="https://twitter.com/divyajha_" class="btn btn-warning text-light px-1 py-0"> <i class="fa fa-twitter"></i> </a>
								<a href="https://www.linkedin.com/in/divya-suman-45a365191/" class="btn btn-primary text-light px-1 py-0"> <i class="fa fa-linkedin"></i> </a>
